...
path_data="${PWD}/data/SIFT1B/siftsmall"
path_model="${PWD}/models/SIFT1B/siftsmall"

path_base="${path_data}/siftsmall_base.fvecs"
path_learn="${path_data}/siftsmall_learn.fvecs"
path_gt="${path_data}/siftsmall_groundtruth.ivecs"
path_q="${path_data}/siftsmall_query.fvecs"
# path_centroids="${path_data}/centroids_sift1b.fvecs"
path_centroids="/home/qfu/centid.vec"
path_precomputed_idxs="/home/qfu//precomputed_idxs_sift1b.ivecs"
