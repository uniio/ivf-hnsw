...
nprobe="500"           # Number of probes at query time
max_codes="100000"     # Max number of codes to visit to do a query
efSearch="500"         # Max number of candidate vertices in priority queue to observe during seaching
...
# Run #
#######
${PWD}/bin/test_ivfhnsw_grouping_sift1b_disk \
                                -M ${M} \
