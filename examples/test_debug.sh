...
nb="2000000"       # Number of base vectors
...
# Run #
#######
${PWD}/bin/test_ivfhnsw_grouping_sift1b_debug \
                                -M ${M} \
